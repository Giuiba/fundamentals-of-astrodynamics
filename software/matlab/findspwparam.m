        ...
        %  references    :
        %    vallado       2013,
        %  [kparr, sumkp, aparr, avgap, adjf107, adjctrf81, adjlstf81, obsf107, obsctr81, obslst81] = findspwparam( jdtdb, jdtdbF, 'l', spwarr, jdspwstart)
        % --------------------------------------------------------------------------- */

        function [kparr, sumkp, aparr, avgap, adjf107, adjctrf81, adjlstf81, obsf107, obsctr81, obslst81] = findspwparam( jdtdb, jdtdbF, interp, spwarr, jdspwstart)
        ...
        jdspwstarto = floor(jdtdb + jdtdbF - jdspwstart);
        recnum = floor(jdspwstarto);
