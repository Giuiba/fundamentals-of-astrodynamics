    ...
    %
    % [reci, veci, aeci] = ecef2eci06 ( recef, vecef, aecef, iau06arr, fArgs, ttt, jdut1, lod, xp, yp,  ddx, ddy, opt1 )
    % ----------------------------------------------------------------------------

    function [reci, veci, aeci] = ecef2eci06 ( recef, vecef, aecef, iau06arr, fArgs, ttt, jdut1, lod, xp, yp,  ddx, ddy, opt1 )
