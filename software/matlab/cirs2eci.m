...
%
% [reci, veci, aeci] = cirs2eci(rcirs, vcirs, acirs, iau06arr, fArgs06, xysarr, ttt, ddx, ddy, opt1 )
% ----------------------------------------------------------------------------

function [reci, veci, aeci] = cirs2eci(rcirs, vcirs, acirs, iau06arr, fArgs06, xysarr, ttt, ddx, ddy, opt1 )
