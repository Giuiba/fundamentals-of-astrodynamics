    ...
    %
    % [recef, vecef, aecef] = eci2ecef06(reci, veci, aeci, iau06arr, fArgs, ttt, jdut1, lod, xp, yp, opt1, ddx, ddy )
    % ----------------------------------------------------------------------------

function [recef, vecef, aecef] = eci2ecef06(reci, veci, aeci, iau06arr, fArgs, ttt, jdut1, lod, xp, yp, opt1, ddx, ddy )
    constastro;
    %      sethelp;

    % ---- ceo based, iau2000
    if option == 'c'
        [x, y, s, pnb] = iau06xys (iau06arr, fArgs, opt1, ttt, ddx, ddy);
        [st]  = iau06era (jdut1 );
    end
