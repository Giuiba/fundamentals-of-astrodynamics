...
function [x ,y, s] = iau06xysS (iau06arr, fArgs, ttt )
        ...
        xsum0 = 0.0;
        for i = 1306: -1 : 1
            tempval = iau06arr.ax0i(i,1)*fArgs(1) + iau06arr.ax0i(i,2)*fArgs(2) + iau06arr.ax0i(i,3)*fArgs(3) + iau06arr.ax0i(i,4)*fArgs(4) + iau06arr.ax0i(i,5)*fArgs(5) + ...
                iau06arr.ax0i(i,6)*fArgs(6)  + iau06arr.ax0i(i,7)*fArgs(7)  + iau06arr.ax0i(i,8)*fArgs(8)  + iau06arr.ax0i(i,9)*fArgs(9) + ...
                iau06arr.ax0i(i,10)*fArgs(10) + iau06arr.ax0i(i,11)*fArgs(11) + iau06arr.ax0i(i,12)*fArgs(12) + iau06arr.ax0i(i,13)*fArgs(13) + iau06arr.ax0i(i,14)*fArgs(14);
        ...
        ysum0 = 0.0;
        for i = 962: -1 : 1
            tempval = iau06arr.ay0i(i,1)*fArgs(1) + iau06arr.ay0i(i,2)*fArgs(2) + iau06arr.ay0i(i,3)*fArgs(3) + iau06arr.ay0i(i,4)*fArgs(4) + iau06arr.ay0i(i,5)*fArgs(5) + ...
                iau06arr.ay0i(i,6)*fArgs(6)  + iau06arr.ay0i(i,7)*fArgs(7)  + iau06arr.ay0i(i,8)*fArgs(8)  + iau06arr.ay0i(i,9)*fArgs(9) + ...
                iau06arr.ay0i(i,10)*fArgs(10) + iau06arr.ay0i(i,11)*fArgs(11) + iau06arr.ay0i(i,12)*fArgs(12) + iau06arr.ay0i(i,13)*fArgs(13) + iau06arr.ay0i(i,14)*fArgs(14);
        ...
        ssum0 = 0.0;
        for i = 33: -1 : 1
            tempval = iau06arr.as0i(i,1)*fArgs(1) + iau06arr.as0i(i,2)*fArgs(2) + iau06arr.as0i(i,3)*fArgs(3) + iau06arr.as0i(i,4)*fArgs(4) + iau06arr.as0i(i,5)*fArgs(5) + ...
                iau06arr.as0i(i,6)*fArgs(6)  + iau06arr.as0i(i,7)*fArgs(7)  + iau06arr.as0i(i,8)*fArgs(8)  + iau06arr.as0i(i,9)*fArgs(9) + ...
                iau06arr.as0i(i,10)*fArgs(10) + iau06arr.as0i(i,11)*fArgs(11) + iau06arr.as0i(i,12)*fArgs(12) + iau06arr.as0i(i,13)*fArgs(13) + iau06arr.as0i(i,14)*fArgs(14);
