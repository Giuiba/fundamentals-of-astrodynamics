    ...
    %
    % [rcirs,vcirs,acirs] = ecef2cirs06 ( recef,vecef,aecef,ttt,jdut1,lod,xp,yp,option, ddx, ddy );
    % ----------------------------------------------------------------------------

    function [rcirs,vcirs,acirs] = ecef2cirs06 ( recef,vecef,aecef,ttt,jdut1,lod,xp,yp,option );
constastro;
    sethelp;
