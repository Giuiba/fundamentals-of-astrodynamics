...
%        aecef = [0.001;0.002;0.003];
        ...
        fprintf(1, '%20.15f %20.15f %20.15f\n', st' );
        [st00, stdot00] = sidereal(jdut1+jdut1frac, deltapsi, meaneps, omega, lod, 2);
...
% note you could also have two calculations with the wo corr nutation values
        ...
        [recigg, vecigg, aecig] = ecef2eciiau06 ( recef, vecef, aecef, jdtt + jdttfrac, ttt, jdut1+jdut1frac, lod, xp, yp, '6c', ddx, ddy );
