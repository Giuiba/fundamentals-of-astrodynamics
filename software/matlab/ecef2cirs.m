...
%    vallado       2022, 227
%
% [rcirs,vcirs,acirs] = ecef2cirs(recef, vecef, aecef, iau06arr, ttt, jdut1, ...
%        lod, xp, yp,  ddx, ddy, opt1 );
% ----------------------------------------------------------------------------

function [rcirs, vcirs, acirs] = ecef2cirs(recef, vecef, aecef, iau06arr, ...
        ttt, jdut1, lod, xp, yp,  ddx, ddy, opt1 )
    constastro;
    sethelp;
    st = zeros(3, 3);
