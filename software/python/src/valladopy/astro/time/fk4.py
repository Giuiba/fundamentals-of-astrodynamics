...
def fk4() -> np.ndarray:
    """Returns the B1950 to J2000 conversion matrix (in-book approach).
...
def fk4_extended() -> np.ndarray:
    """Returns the B1950 to J2000 conversion matrix (6x6 extended version).
