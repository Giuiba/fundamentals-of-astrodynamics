...
class TestFlightCartesian:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                np.array(
                    [
                        [1.0883567059765465e-07, -2.4648720677173544e-08,
                         -5.0788923011001195e-09, -6.505021243065809e-10,
                         7.039625138133815, 0.0005108287705099376],
                        [-2.464872067717354e-08, 5.879500790159742e-09,
                         1.2481764470383299e-09, 1.5358534332993033e-10,
                         -1.6519622216648082, -0.00012043162458763846],
                        [-5.078892301100135e-09, 1.248176447038331e-09,
                         0.008374102968607102, -5.941656352563438e-05,
                         -0.33768416998404877, -244.41693377498171],
                        [-6.505021243065809e-10, 1.5358534332993033e-10,
                         -5.94165635256344e-05, 3.950226823514596e-06,
                         -0.043176717726581305, 1.7279198348281204],
                        [7.039625138133814, -1.6519622216648082,
                         -0.3376841699840489, -0.04317671772658131,
                         467373780.37122524, 33917.46568190547],
                        [0.0005108287705099377, -0.00012043162458763847,
                         -244.4169337749818, 1.7279198348281208,
                         33917.46568190547, 7133885.581683842]
                    ]
                )
            ),
            (
                ...
                np.array(
                    [
                        [5.507136039838392e-09, -1.1399655720883035e-09,
                         -5.766104151460021e-10, -7.506387828610423e-11,
                         0.8103026599250637, 5.875693365269568e-05],
                        [-1.1399655720883031e-09, 9.747003637887425e-10,
                         5.366459884434408e-10, 6.265580156852079e-11,
                         -0.6674651097650145, -4.898688798414044e-05],
                        [-5.766104151460069e-10, 5.3664598844344e-10,
                         0.008374102968607102, -5.941656352563438e-05,
                         -0.33768416998404877, -244.41693377498171],
                        [-7.50638782861043e-11, 6.265580156852079e-11,
                         -5.94165635256344e-05, 3.950226823514596e-06,
                         -0.043176717726581305, 1.7279198348281204],
                        [0.8103026599250636, -0.6674651097650146, -0.3376841699840489,
                         -0.04317671772658131, 467373780.37122524, 33917.46568190547],
                        [5.875693365269569e-05, -4.898688798414044e-05,
                         -244.4169337749818, 1.7279198348281208, 33917.46568190547,
                         7133885.581683842]
                    ]
                )
            )
    ...
    def test_covct2fl(self, cartcov, cartstate, use_latlon, tm_exp, cartcov_exp):
        # Input values
        ...
        # Expected values
        assert custom_allclose(flcov, cartcov_exp)
        assert custom_allclose(tm, tm_exp)
