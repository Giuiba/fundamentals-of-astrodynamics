...
@pytest.mark.parametrize(
    "year, days, mdh_exp",
    [
        (2023, 1, (1, 1, 0, 0, 0)),  # Jan 1, 2023, 00:00:00
        (2023, 365, (12, 31, 0, 0, 0)),  # Dec 31, 2023, 00:00:00
        (2023, 34.567, (2, 3, 13, 36, 28.8)),  # Feb 3, 2023, 13:36:28.800
        (2024, 60, (2, 29, 0, 0, 0)),  # Feb 29, 2024, 00:00:00 (leap year)
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ((2023, 1, 1, 0, 0, 0), 1),  # Jan 1, 2023, 00:00:00
