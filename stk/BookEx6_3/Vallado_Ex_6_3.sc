...
BEGIN Animation
    ...
    EndTimeStr         +14 days
    CurrentTime        25 Dec 2012 03:27:29.000000000
    Mode               Stop
    Direction          Forward
...
BEGIN References
    ...
    END Instance
    Instance Satellite/interceptorT
        Satellite/interceptorT
    END Instance
    Instance Satellite/interceptorT1
        Satellite/interceptorT1
    END Instance
