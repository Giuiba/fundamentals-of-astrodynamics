...
BEGIN Epoch
    Epoch        25 Dec 2012 00:00:00.000000
...
BEGIN Animation
    ...
    EndTimeStr         +14 days
    CurrentTime        25 Dec 2012 04:17:30.000000000
    Mode               Stop
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            ...
            UseCloudsFile        Off
            BEGIN ZoomBounds
                -1.739614 -85.621560 1.126175 -77.450387
                -3.966942 -90.309697 3.471074 -69.249821
...
<OBJECT Class = "RFEnvironment" Name = "STK_RF_Environment">
	...
	BEGIN RCSBAND
		LinearConstantValue      0.000000e+000
		Swerling      0
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Satellite/interceptor
